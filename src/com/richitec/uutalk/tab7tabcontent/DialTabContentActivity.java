...
import com.richitec.uutalk.call.OutgoingCallGenerator;
...
public class DialTabContentActivity extends NavigationActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// get exported dial phone
		String _exportedDialPhone = (String) UserManager.getInstance()
				.getUser().popValue(TelUser.exported_dial_phone.name());
		// set its default text
		_mDialPhoneTextView.setText(null == _exportedDialPhone
				|| "".equalsIgnoreCase(_exportedDialPhone) ? ""
				: _exportedDialPhone);
