...
import com.richitec.uutalk.account.AccountForgetPSWActivity;
...
import com.richitec.uutalk.constant.LaunchSetting;
...
import com.richitec.uutalk.utils.AppUpdateManager;
import com.richitec.uutalk.utils.CountryCodeManager;
import com.richitec.uutalk.utils.DialPreferenceManager;
...
public class SettingActivity extends NavigationActivity {
	...
	private SetDialAreaCodePopupWindow setDialCountryCodePopupWindow;
	...
	public void setDialCountryCode(View v) {
		setDialCountryCodePopupWindow = new SetDialAreaCodePopupWindow(
	...
	private static void setDialAreaCode(String dialareaCode) {
		...
		DataStorageUtils
				.putObject(TelUser.local_area_code.name(), dialareaCode);
	}
	...
	static class SetDialAreaCodePopupWindow extends CTPopupWindow {
		...
		class SetDialCountryCodeConfirmBtnOnClickListener implements
			...
			public void onClick(View v) {
				...
				// R.id.set_dial_country_btn)).getText()
				// .toString().trim());
				String dialareacode = ((EditText) SetDialAreaCodePopupWindow.this
						.getContentView().findViewById(
								R.id.set_dial_areaCode_editText)).getText()
						.toString();

				Log.d("dialareacode", dialareacode);
				setDialAreaCode(dialareacode);
	...
	class SetBindNumberPopupWindow extends CTPopupWindow {
		...
		private void setBindNumber(String phone, String country) {
			...
			String countryCode = (String) userBean.getValue(TelUser.countryCode
					.name());
			newBindCountryCode = countryCode;
			newBindPhone = phone;
			HashMap<String, String> params = new HashMap<String, String>();
			params.put("username", username);
			params.put("countryCode", countryCode);
