...
public class AccountDirectRegisterActivity extends Activity {
	...
	public void onRegisterAction(View v) {
		...
		String countryCode = getString(R.string.default_country_code);
		if (countryCode == null) {
		...
		if (phoneNumber == null || phoneNumber.equals("")) {
			...
			MyToast.show(this, R.string.phone_number_must_be_angola_number, Toast.LENGTH_SHORT);
			return;
		}
